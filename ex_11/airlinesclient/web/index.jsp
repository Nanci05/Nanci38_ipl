<%-- 
    Document   : index
    Created on : 21 May, 2023, 7:41:05 PM
    Author     : Nanci Arokia 
--%>
...
<html>
   ...
   mt1{
    ...
    <%
    try {
	nanci.Airlinesserver_Service service = new nanci.Airlinesserver_Service();
	nanci.Airlinesserver port = service.getAirlinesserverPort();
