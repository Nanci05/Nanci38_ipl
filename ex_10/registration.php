...
if (empty($errors)) {
    ...
    $sql = "INSERT INTO passenger (passenger_RatingPoints, passenger_name, passenger_email, passenger_pass, passenger_country, passenger_city, passenger_contact, passenger_address) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
